...
sed -i "s#CORE_FS_DEFAULTFS#$CORE_FS_DEFAULTFS#g" /opt/hadoop/etc/hadoop/core-site.xml
...
sed -i "s#YARN_YARN_RESOURCEMANAGER_CLUSTER_ID#$YARN_YARN_RESOURCEMANAGER_CLUSTER_ID#g" /opt/hadoop/etc/hadoop/yarn-site.xml
sed -i "s#YARN_YARN_RESOURCEMANAGER_ZK_ADDRESS#$YARN_YARN_RESOURCEMANAGER_ZK_ADDRESS#g" /opt/hadoop/etc/hadoop/yarn-site.xml
...
sed -i "s#YARN_YARN_NODEMANAGER_LOCAL_DIRS#$YARN_YARN_NODEMANAGER_LOCAL_DIRS#g" /opt/hadoop/etc/hadoop/yarn-site.xml
sed -i "s#YARN_YARN_NODEMANAGER_LOG_DIRS#$YARN_YARN_NODEMANAGER_LOG_DIRS#g" /opt/hadoop/etc/hadoop/yarn-site.xml
sed -i "s#YARN_YARN_NODEMANAGER_REMOTE_APP_LOG_DIR#$YARN_YARN_NODEMANAGER_REMOTE_APP_LOG_DIR#g" /opt/hadoop/etc/hadoop/yarn-site.xml

sed -i "s#MAPRED_MAPREDUCE_JOBHISTORY_ADDRESS#$MAPRED_MAPREDUCE_JOBHISTORY_ADDRESS#g" /opt/hadoop/etc/hadoop/mapred-site.xml
sed -i "s#MAPRED_MAPREDUCE_JOBHISTORY_WEBAPP_ADDRESS#$MAPRED_MAPREDUCE_JOBHISTORY_WEBAPP_ADDRESS#g" /opt/hadoop/etc/hadoop/mapred-site.xml
sed -i "s#MAPRED_MAPREDUCE_JOBHISTORY_INTERMEDIATE_DONE_DIR#$MAPRED_MAPREDUCE_JOBHISTORY_INTERMEDIATE_DONE_DIR#g" /opt/hadoop/etc/hadoop/mapred-site.xml
sed -i "s#MAPRED_MAPREDUCE_JOBHISTORY_DONE_DIR#$MAPRED_MAPREDUCE_JOBHISTORY_DONE_DIR#g" /opt/hadoop/etc/hadoop/mapred-site.xml
