  ...
  urlTempData: {
    ...
    Overview: { //总览模块
      Overview: { //总览页面
        ...
        BDMS_OVERVIEW: "v1/k8s/api/dashboard/taskinfo?random=${random}",
        K8SP_OVERVIEW: "v1/k8s/api/namespaces/${spaceName}/k8soverview?random=${random}",
        ...
        OPENSTACK_OVERVIEW:"v1/openstack/home/overview/?random=${random}",
      }
    },
    //用户管理模块url模版
    UserAuth: {
  ...
  navigationData: {
    ...
    K8sMonitor: {
      ...
      ResourceUsage: {
        ...
        navigationTexts: [{
          text: "资源用量",
          url: "/CloudContainer/CalcManage/ResourceUsage?cur_space=${spaceName}"
        }]
      },
      PodInfo: {
        headText: "Pod信息",
