...
const Navigate = React.createClass({
  ...
  listManager:{
    0:function(){
      return <div className="function-hdfs-margin-div">
            <span>全部文件</span>
            <span className="function-hdfs-list-tips">已全部加载, 共{this.props.num}个</span>
            </div>
    },
    1:function(){
      var ret = [];
      ...
      return <div className="function-hdfs-margin-div">{ret} <span className="function-hdfs-list-tips">已全部加载, 共{this.props.num}个</span></div>;
    }
  },
