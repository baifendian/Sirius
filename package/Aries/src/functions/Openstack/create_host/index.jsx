        ...
        return (
          <div key={ i }>
            <FormItem label="数据盘" name={disk} className="disk_create">
              <FormInput placeholder="2BG" ref={disk}></FormInput><Icon type=" fa-times"
                                                                        onClick={this.create_disk.bind(this, 2, {i})}/>
            </FormItem>
          </div>
        )
      }
            ...
            >
              ...
              <FormItem label="磁盘" name="name" className="disk_left" style={{height: '200px', overflow: 'auto'}}>
                ...
                <div>
                  ...
                  className="disk_span">{this.state.test_mum}</span><span>快</span>
                </div>
              </FormItem>
              <button type="button" style={{marginLeft: '100px'}} className="btn btn-primary" onClick={this.handleSave}>
                创建
              </button>
            </Form>
          </div>
