        	...
        	<Row>
      			<Col col="md-8" >
      				<Row style={{height: "500px"}}>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">名称:</Col>
      					<Col col="md-10" className="left_hostname" >
      						<ClearableInput />
      					</Col>
      					...
      					<br/>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">台数:</Col>
      					<Col col="md-10" className="left_hostname" >
      						<ClearableInput />
      					</Col>
      					...
      					<br/>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">类型:</Col>
      					<Col col="md-10" >
      						<Select>
       							<Option>请选择</Option>
						...
						<br/>
      					...
      					<div>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">CPU:</Col>
      					<Col col="md-10" >
      						<h4 className="left_cpu">1核</h4>
      					</Col>
      					</div>
      					</div>
      					<br/>
      					...
      					<div>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">内存:</Col>
      					<Col col="md-10" >
      						<h4 className="left_cpu">2GB</h4>
      					</Col>
      					</div>
      					</div>
      					<br/>
      					...
      					<div>
      					<div className="left_host">
      					<Col col="md-2" className="left_type">磁盘:</Col>
      					<Col col="md-10" >
      						<h4 className="left_cpu">2GB</h4>
      					</Col>
      					</div>
      			...
      			<Col col="md-4" style={{backgroundColor: '#bbdefb'}}>md-8</Col>
    		</Row>
